...
case "${SS_PRESET^^}" in
  HARD)
    export SS_BOT_DIFFICULTY=0.9 SS_MIN_ENEMIES=10 SS_MAX_ENEMIES=24 SS_BOT_QUOTA=16.0
    ...
    ;;
  INSANE)
    export SS_BOT_DIFFICULTY=1.0 SS_MIN_ENEMIES=14 SS_MAX_ENEMIES=30 SS_BOT_QUOTA=22.0
    ...
    ;;
  NIGHTMARE)
    export SS_BOT_DIFFICULTY=1.0 SS_MIN_ENEMIES=18 SS_MAX_ENEMIES=36 SS_BOT_QUOTA=28.0
